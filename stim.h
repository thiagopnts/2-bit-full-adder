...
SC_MODULE(stim) {
    ...
    void StimGen() {
        ...
        wait();
        A1.write(false); A2.write(false); B1.write(false); B2.write(false); Cin.write(true);
        wait();
        A1.write(false); A2.write(false); B1.write(false); B2.write(true); Cin.write(false);
        wait();
        A1.write(false); A2.write(false); B1.write(false); B2.write(true); Cin.write(true);
        wait();
        A1.write(false); A2.write(false); B1.write(true); B2.write(false); Cin.write(false);
        wait();
        A1.write(false); A2.write(false); B1.write(true); B2.write(false); Cin.write(true);
        wait();
        A1.write(false); A2.write(false); B1.write(true); B2.write(true); Cin.write(false);
        wait();
        A1.write(false); A2.write(false); B1.write(true); B2.write(true); Cin.write(true);
        wait();
        A1.write(false); A2.write(true); B1.write(false); B2.write(false); Cin.write(false);
        wait();
        A1.write(false); A2.write(true); B1.write(false); B2.write(false); Cin.write(true);
        wait();
        A1.write(false); A2.write(true); B1.write(false); B2.write(true); Cin.write(false);
        wait();
        A1.write(false); A2.write(true); B1.write(false); B2.write(true); Cin.write(true);
        wait();
        A1.write(false); A2.write(true); B1.write(true); B2.write(false); Cin.write(false);
        wait();
        A1.write(false); A2.write(true); B1.write(true); B2.write(false); Cin.write(true);
        wait();
        A1.write(false); A2.write(true); B1.write(true); B2.write(true); Cin.write(false);
        wait();
        A1.write(false); A2.write(true); B1.write(true); B2.write(true); Cin.write(true);
        wait();
        A1.write(true); A2.write(false); B1.write(false); B2.write(false); Cin.write(false);
        wait();
        A1.write(true); A2.write(false); B1.write(false); B2.write(false); Cin.write(true);
        wait();
        A1.write(true); A2.write(false); B1.write(false); B2.write(true); Cin.write(false);
        wait();
        A1.write(true); A2.write(false); B1.write(false); B2.write(true); Cin.write(true);
        wait();
        A1.write(true); A2.write(false); B1.write(true); B2.write(false); Cin.write(false);
        wait();
        A1.write(true); A2.write(false); B1.write(true); B2.write(false); Cin.write(true);
        wait();
        A1.write(true); A2.write(false); B1.write(true); B2.write(true); Cin.write(false);
        wait();
        A1.write(true); A2.write(false); B1.write(true); B2.write(true); Cin.write(true);
        wait();
        A1.write(true); A2.write(true); B1.write(false); B2.write(false); Cin.write(false);
        wait();
        A1.write(true); A2.write(true); B1.write(false); B2.write(false); Cin.write(true);
        wait();
        A1.write(true); A2.write(true); B1.write(false); B2.write(true); Cin.write(false);
        wait();
        A1.write(true); A2.write(true); B1.write(false); B2.write(true); Cin.write(true);
        wait();
        A1.write(true); A2.write(true); B1.write(true); B2.write(false); Cin.write(false);
        wait();
        A1.write(true); A2.write(true); B1.write(true); B2.write(false); Cin.write(true);
        wait();
        A1.write(true); A2.write(true); B1.write(true); B2.write(true); Cin.write(false);
        wait();
        A1.write(true); A2.write(true); B1.write(true); B2.write(true); Cin.write(true);
        wait();
        sc_stop();
    }
    SC_CTOR(stim) {
